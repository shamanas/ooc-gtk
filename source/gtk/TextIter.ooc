...
TextIter: cover from GtkTextIter* {
     ...
     */
    getOffset: extern(gtk_text_iter_get_offset) func -> GInt
     ...
     */
    getLine: extern(gtk_text_iter_get_line) func -> GInt   
     ...
     */
    getLineOffset: extern(gtk_text_iter_get_line_offset) func -> GInt
     ...
     */
    getLineIndex: extern(gtk_text_iter_get_line_index) func -> GInt
     ...
     */
    getVisibleLineIndex: extern(gtk_text_iter_get_visible_line_index) func -> GInt
     ...
     */
    getVisibleLineOffset: extern(gtk_text_iter_get_visible_line_offset) func -> GInt
     ...
     */
    getChar: extern(gtk_text_iter_get_char) func -> GUniChar
     ...
     */
    //getToggledTags: extern(gtk_text_iter_get_toggled_tags) func(toggled_on: GBool) -> GSList
     ...
     */
    beginsTag?: extern(gtk_iter_begins_tag) func(tag: TextTag) -> GBool

    /**
     * I don't think I need to explain that to you...
     */
    endsTag?: extern(gtk_iter_ends_tag) func(tag: TextTag) -> GBool
     ...
     */
    togglesTag?: extern(gtk_text_iter_toggles_tag) func(tag: TextTag) -> GBool

    /**
     * See description for TextIter beginsTag?
     */
    hasTag?: extern(gtk_text_iter_has_tag) func(tag: TextTag) -> GBool
     ...
     */
    editable?: extern(gtk_text_iter_editable) func(default_setting: GBool) -> GBool

    /**
     * See description for TextIter editable?
     */
    canInsert?: extern(gtk_text_iter_can_insert) func(default_editability: GBool) -> GBool
     ...
     */
    startsLine?: extern(gtk_text_iter_starts_line) func -> GBool

    /**
     * Same as TextIter startsLine? but for ending a line.
     */
    endsLine?: extern(gtk_text_iter_ends_line) func -> GBool
     ...
     */
    startsSentence?: extern(gtk_text_iter_starts_sentence) func -> GBool

    /**
     * Same as TextIter startsSentence? but for ending sentences.
     */
    endsSentence?: extern(gtk_text_iter_ends_sentence) func -> GBool
     ...
     */
    getAttributes: extern(gtk_text_iter_get_attributes) func(values: TextAttributes) -> GBool
     ...
     */
    forwardChar: extern(gtk_text_iter_forward_char) func -> GBool
     ...
     */
    backwardChar: extern(gtk_text_iter_backward_char) func -> GBool
     ...
     */
    forwardChars: extern(gtk_text_iter_forward_chars) func(count: GInt) -> GBool
     ...
     */
    backwardChars: extern(gtk_text_iter_backward_chars) func(count: GInt) -> GBool

    //TODO: Add doc from here and on
    forwardLine: extern(gtk_text_iter_forward_line) func -> GBool
    backwardLine: extern(gtk_text_iter_backward_line) func -> GBool
    forwardLines: extern(gtk_text_iter_forward_lines) func(count: GInt) -> GBool
    backwardLines: extern(gtk_text_iter_backward_lines) func(count: GInt) -> GBool
    forwardWordEnds: extern(gtk_text_iter_forward_word_ends) func(count: GInt) -> GBool
    backwardWordStarts: extern(gtk_text_iter_backward_word_starts) func(count: GInt) -> GBool
    forwardWordEnd: extern(gtk_text_iter_forward_word_end) func -> GBool
    backwardWordStart: extern(gtk_text_iter_backward_word_start) func -> GBool
    forwardCursorPosition: extern(gtk_text_iter_forward_cursor_position) func -> GBool
    backwardCursorPosition: extern(gtk_text_iter_backward_cursor_position) func -> GBool
    forwardCursorPositions: extern(gtk_text_iter_forward_cursor_positions) func(count: GInt) -> GBool
    backwardCursorPositions: extern(gtk_text_iter_backward_cursor_positions) func(count: GInt) -> GBool
    backwardSentenceStart: extern(gtk_text_iter_backward_sentence_start) func -> GBool
    backwardSentenceStarts: extern(gtk_text_iter_backward_sentence_starts) func(count: GInt) -> GBool
    forwardSentenceEnd: extern(gtk_text_iter_forward_sentence_end) func -> GBool
    forwardSentenceEnds: extern(gtk_text_iter_forward_sentence_ends) func(count: GInt) -> GBool
    forwardVisibleWordEnds: extern(gtk_text_iter_forward_visible_word_ends) func(count: GInt) -> GBool
    backwardVisibleWordStarts: extern(gtk_text_iter_backward_visible_word_starts) func(count: GInt) -> GBool
    forwardVisibleWordEnd: extern(gtk_text_iter_forward_visible_word_end) func -> GBool
    backwardVisibleWordStart: extern(gtk_text_iter_backward_visible_word_start) func -> GBool
    forwardVisibleCursorPosition: extern(gtk_text_iter_forward_visible_cursor_position) func -> GBool
    backwardVisibleCursorPosition: extern(gtk_text_iter_backward_visible_cursor_position) func -> GBool
    forwardVisibleCursorPositions: extern(gtk_text_iter_forward_visible_cursor_positions) func(count: GInt) -> GBool
    backwardVisibleCursorPositions: extern(gtk_text_iter_backward_visible_cursor_positions) func(count: GInt) -> GBool
    forwardVisibleLine: extern(gtk_text_iter_forward_visible_line) func -> GBool
    backwardVisibleLine: extern(gtk_text_iter_backward_visible_line) func -> GBool
    forwardVisibleLines: extern(gtk_text_iter_forward_visible_lines) func(count: GInt) -> GBool
    backwardVisibleLines: extern(gtk_text_iter_backward_visible_lines) func(count: GInt) -> GBool
    setOffset: extern(gtk_text_iter_set_offset) func(char_offset: GInt)
    setLine: extern(gtk_text_iter_set_line) func(line_number: GInt)
    setLineOffset: extern(gtk_text_iter_set_line_offset) func(char_on_line: GInt)
    setLineIndex: extern(gtk_text_iter_set_line_index) func(byte_on_line: GInt)
    setVisibleLineIndex: extern(gtk_text_iter_set_visible_line_index) func(byte_on_line: GInt)
    setVisibleLineOffset: extern(gtk_text_iter_set_visible_line_offset) func(char_on_line: GInt)
    forwardToEnd: extern(gtk_text_iter_forward_to_end) func
    forwardToLineEnd: extern(gtk_text_iter_forward_to_line_end) func -> GBool
    forwardToTagToggle: extern(gtk_text_iter_forward_to_tag_toggle) func(tag: TextTag) -> GBool
    backwardToTagToggle: extern(gtk_text_iter_backward_to_tag_toggle) func(tag: TextTag) -> GBool

    // TODO: Adapt to closure (context should be passed as user_data or something like that :P)
    forwardFindChar: extern(gtk_text_iter_forward_find_char) func(pred: Func(GUniChar, GPointer) -> GBool, user_data: GPointer, limit: const This) -> GBool
    backwardFindChar: extern(gtk_text_iter_backward_find_char) func(pred: Func(GUniChar, GPointer) -> GBool, user_data: GPointer, limit: const This) -> GBool

    forwardSearch: extern(gtk_text_iter_forward_search) func(str: const GChar*, flags: TextSearchFlags, match_start,match_end: This, limit: const This) -> GBool
    backwardSearch: extern(gtk_text_iter_backward_search) func(str: const GChar*, flags: TextSearchFlags, match_start,match_end: This, limit: const This) -> GBool

    equals?: extern(gtk_text_iter_equal) func(other: const This) -> GBool
    compare: extern(gtk_text_iter_compare) func(other: const This) -> GInt
    inRange?: extern(gtk_text_iter_in_range) func(start,end: const This) -> GBool
    order: extern(gtk_text_iter_order) func(second: This)
}

operator == (l,r: TextIter) -> GBool { l equals?(r) }
operator <=> (l,r: TextIter) -> GInt { l compare(r) }
